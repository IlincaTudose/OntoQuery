...
<form name="frm" method="get" action="response.jsp">
	...
	<tr>
		...
		<tbody>
			<tr>
				<td><div id="editID" class="dl_edit" contenteditable="true"></div></td>
				<td><img id="incompleteIcon" src="images/icon_alert.gif"
					title="The list of suggested terms is too long to be loaded completely. Please type some more characters for more specific results."></td>
				<td><input type="submit" name="submit" value="Submit"
					id="submitQuery"></td>
				<td><a href="OntoQueryHelp.html" target="_blank"
					title="Click here to go to the ChEBI OntoQuery tutorial page.">
		...
		<!--
		<td>
		<div id="recentOWLQueries"  class="recentQueries">
		<h3  class="recentQueries">Recent Queries</h3>
		<ul class="recentQueries">
			<li> <a class="recentQueries" href="#" onclick="javascript:histEntryClick(this);" id="hist1" >chemical_entity and has_part some chloride or ( chemical_entity and has_part some chloride )</a></li>
			<li> <a class="recentQueries" href="#" onclick="javascript:histEntryClick(this);" id="hist2" >chemical_entity and has_part some chloride</a></li>
		</ul>
		</div>
		</td>
		 -->
...
//				map.push({key: myList[i].toLowerCase(), value:  myList[i].toLowerCase().indexOf(pat)});				
...
//	History thing here
//		$("a.recentQueries").bind("click", function (event) {
		// put query back to the edit box
//		 $("#editID").html($(this).text());
//		 $("div.dl_edit").trigger('editEvent');
		 // pop & push from the cookie list
		 // re-order entries in the Recent queries box
//		 reloadRecentQueries();
//	});
