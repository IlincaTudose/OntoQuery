...
<form name="frm" method="get" action="response.jsp">
	...
	<tr>
		<td>
		<p> Enter your query in the box, selecting from the suggestions list to construct valid queries.<p>
		<table>
		<tbody>
			<tr>
				<td><div id="editID" class="dl_edit" contenteditable="true" title="Insert a query in Manchester OWL syntax here."></div></td>
				...
				<td><input type="submit" name="submit" value="Submit"
					id="submitQuery"></td>
				<td><a href="OntoQueryHelp.jsp" target="_blank"
