...
<div id="content">
    ...
    <h2 class="entry-title" style="text-align: center"><a href="/chebi/tools/ontoquery">OntoQuery</a></h2>
    ...
    <div id="helpContent">
        ...
        <img src="images/1.png" class="imgcenter">
        <img src="images/2.png" class="imgcenter">
        <img src="images/historyBox.png" class="imgcenter">


        <h3>Query Syntax</h3>

        <p>For writing the queries we use the <b>Manchester syntax</b>
        ...
        <ul>
            ...
            <li><b> Restrictions </b> are always required between a
                relation and a class (e.g. <b><span class="relationStyle">has_part</span>
                    <span class="restriction"> some </span> <span
                            class="classStyle">chloride</span></b>)
            </li>
            ...
            <li><b>Boolean binary contructors</b> are always requested
                between 2 class expressions (e.g. <b><span
                        ...
                        class="restriction"> some </span> <span class="classStyle">chloride</span></b>)
            </li>
        ...
        <h5>1. all di- and trisaccharide derivatives which are
            methyl glycosides .</h5>
        ...
        <p class="solution">
            <span class="paranthesis">( </span> <span class="classStyle">disaccharide_derivative
                ...
                class="paranthesis">) </span> <span class="booleanConstructor">and
								</span> <span class="classStyle">methyl_glycoside </span></p>

        <p>An equivalent formulation would be the one below, where the
            ...
            over addition in mathematics.</p>
        ...
        <p class="solution">
            <span class="paranthesis">( </span> <span class="classStyle">disaccharide_derivative
                ...
                class="classStyle">methyl_glycoside </span> <span
                class="paranthesis">) </span></p>

        <h5>2. all secondary metabolites which are also coumarins or
            phenols</h5>
        ...
        <p>You might be tempted to write directly "<b><span
            ...
            interest in ChEBI and check whether it is a <b><span
                    class="classStyle">role</span></b> or <b><span class="classStyle">chemical_entity</span></b>.</p>

        <h5>3. all pyrimidines or phenols which have antibacterial
            properties</h5>
        ...
        <p>Although you might not know the exact name of a particular class in ChEBI (in this case,
            antibacterial_agent),
            simply typing part of the name (e.g. 'antib') into the edit box will cause the correct name to appear in the
            suggestions list. </p>

        <h5>4. all insecticides or acaricides which can also be used
            as fungicides</h5>
        ...
        <p>We hope that you now feel prepared to try building some queries
            on your own. We have a further three exercises.</p>


        <h5>1. Find all lactams that are antibiotics</h5>
        ...
        <button name="q1" class="try"
                onclick="document.getElementById('s1').style.visibility='visible';">Show
            solution
        </button>


        <h5>2. Find all organic sodium salts that are steroids and
            are conjugate acid of organosulfate oxoanion.</h5>
        ...
        <button name="q2" class="try"
                onclick="document.getElementById('s2').style.visibility='visible';">Show
            solution
        </button>


        <h5>3. Find all antibacterial and antifungal which can also
            be used as antibiotics.</h5>
        ...
        <p>If you have any queries, comments or suggestions about the OntoQuery tool and tutorial,
            please <a href="/chebi/emailChebiForward.do" target="_blank">contact us</a>.</p>
